<?php
/**
 * Description of ddFoursquareUser
 *
 * @author ner0tic
 */
class ddFoursquareUser { //extends ddFoursquareBase {
  protected
          $id                 = null,
          $createdAt          = null,
          $oAuthToken         = null,
  ...
  public function setPhoto(ddFoursquarePhoto $p) {
    $this->photo = $p;
    return $this;
  }
